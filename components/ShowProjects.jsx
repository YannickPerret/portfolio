    ...
    return (
        <section id="show-project" className="py-20 bg-gray-100">
            <div className="container mx-auto px-6">
                <div>
                    <Link href={`/#projects`} scroll={true} className="inline-block text-black py-3 px-6 rounded transition duration-300 hover:underline">
                ...
                <div className="flex justify-end mt-12">
                    {project.url ? (
                        ...
                        <span className="inline-block bg-gray-300 text-gray-600 font-semibold py-3 px-6 rounded cursor-not-allowed">
                            Site non disponible
                        </span>
                    )}
